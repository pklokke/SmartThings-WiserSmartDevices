...
metadata {
	definition(name: "Wiser Thermostat RTS", namespace: "pklokke", author: "pklokke", runLocally: true, executeCommandsLocally: false, mnmn: "SmartThings", genericHandler: "Zigbee") {
...
def configure() {
	...
	return bindingCmds + configCmds + refresh() // send refresh cmds as part of config
}
